...
\section*{SKILLS}
\begin{itemize}
    \item \textbf{Languages \& Development:} Proficient in Python for scientific computing and data analysis (NumPy, SciPy, Pandas) and high-concurrency applications (Asyncio, WebSockets). Experience with MATLAB, Java, and shell scripting.
    ...
    \item \textbf{Software \& Toolchain:} uv (package \& project management), ruff, ty, Docker (containerization), AWS (Cloud Hosting), Git, GitHub Actions (CI/CD), SQLModel, Parquet, and LaTeX.
    ...
    \industryversion{\item \textbf{Financial Experience:} Manual trading in prediction markets and global equity markets (stocks).}
...
\begin{itemize}
    ...
    \item Skills: Python, asyncio, websockets, parquet, SQLModel, AWS, Docker, risk management.
\end{itemize}
...
\begin{itemize}
    ...
    \item Skills: Python, Pandas, Scikit-learn, XGBoost, Hidden Markov Models, backtesting.
\end{itemize}
