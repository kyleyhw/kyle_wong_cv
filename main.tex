...
\begin{itemize}
    ...
    \industryversion{\item \textbf{Financial Experience:} Manual trading in prediction markets (Polymarket) and global equity markets (stocks).}
