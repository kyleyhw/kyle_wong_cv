...
\begin{itemize}
    \item \versiontext{Developed an event-driven engine for prediction markets, implementing a real-time data ingestion and execution pipeline with modular strategy support and robust error handling.}{A modular trading engine featuring automated risk management, real-time portfolio tracking, and optimized position sizing via the Kelly Criterion.}
    \item Skills: Python, SQLModel, HTTPX, data engineering, risk management, Docker.
\end{itemize}
...
\begin{itemize}
    \item \versiontext{Architected a market-agnostic algorithmic trading framework using the Adapter pattern to decouple core logic from broker APIs, incorporating statistical learning and machine learning models.}{An "Open Core" algorithmic trading platform with a scalable architecture, providing a unified foundation for backtesting and live execution with Interactive Brokers (IBKR).}
    \item Skills: Python, Pandas, NumPy, Scikit-learn, XGBoost, Interactive Brokers API.
\end{itemize}
