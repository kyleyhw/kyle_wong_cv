...
\textbf{wave\_simulation}
\begin{itemize}
    \item A numerical N-dimensional simulation for physical waves, including the possibility to draw physical boundaries and obstacles with wave interactions in a box. 
\end{itemize}

\textbf{handwriting\_recognition}
\begin{itemize}
...
\begin{multicols}{2}
\begin{itemize}
    \item Gravitational Waves and Numerical Relativity (Cambridge, 2025)
