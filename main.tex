...
\begin{itemize}
    \item \textbf{sound\_simulation} (\url{https://github.com/kyleyhw/sound_simulation})
    \begin{itemize}
    ...
    \item \textbf{digit\_recognition} (\url{https://github.com/kyleyhw/digit_recognition})
    \begin{itemize}
    ...
    \item \textbf{driver\_assignment} (\url{https://github.com/kyleyhw/driver_assignment})
    \begin{itemize}
