...
\begin{itemize}
   \item Developed a CNN using PyTorch for real-time MNIST digit recognition, featuring an interactive GUI with advanced preprocessing,
     comprehensive documentation, robust testing, and checkpointing.
...
\begin{itemize}
    \item  An application of constraint programming to the vehicle routing problem, assigning passengers to drivers by minimizing a Haversine distance-based cost function. Developed to provide a scalable framework for real-world logistical challenges like ride-sharing coordination.
